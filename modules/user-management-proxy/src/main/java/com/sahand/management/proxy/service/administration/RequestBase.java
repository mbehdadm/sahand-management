 ...
 *         &lt;element name="credential" type="{http://service.administration.industrial.sahand.com/}credential" minOccurs="0"/>
...
public class RequestBase {
     ...
     *     
     */
    public void setRequstDate(Date value) {
	...
	public String toString() {
		return "RequestBase [clientIpAddress=" + clientIpAddress
				+ ", credential=" + credential + ", mac=" + mac
				+ ", proccessCode=" + proccessCode + ", requstDate="
				+ requstDate + ", sessionId=" + sessionId + ", userName="
				+ userName + "]";
	}
