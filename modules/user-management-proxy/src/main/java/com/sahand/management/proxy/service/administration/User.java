...
public class User {
	...
	public String toString() {
		return "User [creationDate=" + creationDate + ", creatorUser="
				+ creatorUser + ", enabled=" + enabled + ", expirationDate="
				+ expirationDate + ", fullName=" + fullName + ", id=" + id
				+ ", modifierUser=" + modifierUser + ", modifyDate="
				+ modifyDate + ", name=" + name + ", password=" + password
